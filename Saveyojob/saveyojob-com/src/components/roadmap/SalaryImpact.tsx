...
export default function SalaryImpact({ data }: SalaryImpactProps) {
  ...
  return (
    <div>
      ...
      <div className="mt-5 px-4 py-3 bg-surface-2 border border-line rounded-xl flex items-center justify-between">
        <span className="text-[13px] text-ink-2">Difference by acting now</span>
        <span className="text-[18px] font-bold text-fire tracking-tight">
          +{fmt(delta)} / yr
        </span>
      </div>
    </div>
