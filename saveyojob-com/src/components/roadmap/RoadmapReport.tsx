  ...
  return (
    <section>
      <div className="flex items-center gap-3 mb-5">
        <span className="text-[11px] font-bold uppercase tracking-[0.13em] text-paper-3 whitespace-nowrap">
          {label}
        </span>
    ...
    <div className="bg-ink min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-10">
        ...
        {data.positiveOutlook && (
          <div className="border border-acid/20 border-l-[3px] border-l-acid rounded-xl px-5 py-4 bg-acid/[0.04]">
            <div className="text-[11px] font-bold uppercase tracking-[0.12em] text-acid mb-2">
              Your outlook
            </div>
            <p className="text-[14px] text-paper-2 leading-relaxed">{data.positiveOutlook}</p>
          </div>
        )}
